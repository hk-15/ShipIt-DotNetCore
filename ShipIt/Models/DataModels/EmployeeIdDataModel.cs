...
{
    public class EmployeeIdDataModel : DataModel
    {
        ...
        public EmployeeIdDataModel(IDataReader dataReader) : base(dataReader)
        { }

        public EmployeeIdDataModel()
        { }

        public EmployeeIdDataModel(Employee employee)
        {
